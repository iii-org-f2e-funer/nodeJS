...
router.get("/message/:user_id",(req,res)=>{
  ...
  router.post("/message/:user_id",(req,res)=>{
    console.log("req id:",req.params.user_id)
    let bodyData=req.body[0]
